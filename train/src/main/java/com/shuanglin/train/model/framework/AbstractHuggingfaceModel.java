...
/**
 * HuggingFace 框架模型抽象基类
 * 提供 HuggingFace Transformers 格式模型的通用实现
 */
public abstract class AbstractHuggingfaceModel implements DjlModel {

    protected final ModelProperties.ModelConfig config;
    protected boolean loaded = false;

    protected AbstractHuggingfaceModel(ModelProperties.ModelConfig config) {
        this.config = config;
    }
